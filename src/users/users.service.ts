...
export class UsersService {
    constructor(@InjectModel(UserModel) private usersRepository: typeof UserModel) {}
    ...
    async getUserByEmail(email: string) {
        return await this.usersRepository.findOne({where: {email: email}, include: {all: true}})
    }
